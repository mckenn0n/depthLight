        ...
        if (on)
        {
            ...
            if (triggerButtonDown)
            {
                ...
                */
                ...
                DrawLine(location.transform.position, bottom.transform.position, custColor);
                DrawLine(location.transform.position, botR.transform.position, custColor);
                DrawLine(location.transform.position, botL.transform.position, custColor);
                DrawLine(location.transform.position, top.transform.position, custColor);
                DrawLine(location.transform.position, topL.transform.position, custColor);
                DrawLine(location.transform.position, topR.transform.position, custColor);
            }
